...
```{r, warning = F, message = F}
patent77_1 <- process_patents(filepath = "~/Box/d-rug/data/uspto_1977_10.csv")
summary(patent77_1)
```
...
```{r, warning = F, message = F}
patent77_1 <- process_patents(filepath = "~/Box/d-rug/data/uspto_1977_11.csv")
summary(patent77_1)
```

Better. But this still only reduces our code chunk from 3 to 1, and still leaves us to paste in every file path. So now it is time to move to iteration.
