...
Say I want to map multiple Fraxinus species all in one plot. In order to do so, I will need to download the data for each Fraxinus species, combine each respective dataset into one dataframe, and then can use this dataframe to plot the range of multiple species. 
